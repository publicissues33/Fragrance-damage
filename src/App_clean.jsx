...
import { Shield, AlertTriangle, Globe, Microscope, Scale, Gavel, ChevronDown, Download, ExternalLink } from 'lucide-react';

// 導入圖片
import heroImage from '/hero-image.png';
import naturalDefenseImage from '/natural-defense-system.png';
import globalMovementImage from '/global-movement.png';
import nanoPollutionImage from '/nano-pollution.png';
...
function App() {
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full bg-black/80 backdrop-blur-sm z-50 border-b border-white/10">
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="text-xl font-bold">香味不是品味，而是污染</div>
            <div className="hidden md:flex space-x-6">
              <a href="#defense" className="hover:text-red-400 transition-colors">天然警報</a>
              <a href="#deception" className="hover:text-orange-400 transition-colors">業界真相</a>
              <a href="#movement" className="hover:text-green-400 transition-colors">全球運動</a>
              <a href="#nano" className="hover:text-purple-400 transition-colors">奈米危害</a>
              <a href="#rights" className="hover:text-blue-400 transition-colors">維權指南</a>
              <a href="#legal" className="hover:text-gray-400 transition-colors">法庭真相</a>
            </div>
          </div>
        </div>
      </nav>
      ...
      {/* 主頁面 */}
      <section className="min-h-screen flex items-center justify-center relative bg-gradient-to-br from-red-900 via-black to-orange-900">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 border-2 border-white/30 text-white hover:bg-white/10 rounded-lg font-semibold transition-colors"
      ...
      {/* 第一章：被顛覆的天然警報系統 */}
      <section id="defense" className="min-h-screen py-20 bg-gradient-to-br from-blue-900 to-slate-900">
